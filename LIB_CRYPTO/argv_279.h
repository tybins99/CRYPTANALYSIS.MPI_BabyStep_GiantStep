...
#define argv_1862     ((~(argv_2564) 0) >> argv_1859)
...
#if argv_438 || __GMP_FORCE_mpz_abs
...
argv_426 void *argv_3427 argv_443 ((void *, size_t *, int, size_t, int, size_t, argv_3524 z));
...
#if argv_438 || __GMP_FORCE_mpz_neg
...
#if argv_438 || __GMP_FORCE_mpz_perfect_square_p
argv_426 int argv_3496 argv_443 ((argv_3524)) argv_422;
#endif

#define mpz_popcount __gmpz_popcount
#if argv_438 || __GMP_FORCE_mpz_popcount
...
#if argv_438 || __GMP_FORCE_mpz_set_q
...
#if argv_438 || __GMP_FORCE_mpz_size
...
#if argv_438 || __GMP_FORCE_mpq_abs
...
#if argv_438 || __GMP_FORCE_mpq_neg
...
#define argv_3317(qp,np,nsize,dlimb) \
  argv_3319 (qp, (argv_2568) 0, np, nsize, dlimb)
...
#if defined (argv_430) && ! __GMP_FORCE_mpz_abs
argv_430 void
...
#if defined (argv_430) || __GMP_FORCE_mpz_fits_uint_p
...
#if defined (argv_430) || __GMP_FORCE_mpz_fits_ulong_p
...
#if defined (argv_430) || __GMP_FORCE_mpz_fits_ushort_p
...
#if defined (argv_430) || __GMP_FORCE_mpz_get_ui
...
#if defined (argv_430) || __GMP_FORCE_mpz_getlimbn
...
#if defined (argv_430) && ! __GMP_FORCE_mpz_neg
argv_430 void
...
#if defined (argv_430) || __GMP_FORCE_mpz_perfect_square_p
...
#if defined (argv_430) || __GMP_FORCE_mpz_popcount
...
#if defined (argv_430) || __GMP_FORCE_mpz_set_q
...
#if defined (argv_430) || __GMP_FORCE_mpz_size
...
#if defined (argv_430) && ! __GMP_FORCE_mpq_abs
argv_430 void
...
#if defined (argv_430) && ! __GMP_FORCE_mpq_neg
argv_430 void
...
#if defined (argv_430) || __GMP_FORCE_mpn_add
...
#if defined (argv_430) || __GMP_FORCE_mpn_add_1
...
#if defined (argv_430) || __GMP_FORCE_mpn_cmp
...
#if defined (argv_430) || __GMP_FORCE_mpn_sub
...
#if defined (argv_430) || __GMP_FORCE_mpn_sub_1
...
#define argv_3405(Z,SI) \
  (__builtin_constant_p (SI) && (SI) == 0 ? argv_3518 (Z)			\
   : __builtin_constant_p (SI) && (SI) > 0				\
    ? argv_613 (Z, (unsigned long int) SI)				\
   : argv_612 (Z,SI))
...
/* Using "&" rather than "&&" means these can come out branch-free.  Every
   ...
   allowed.  */
#define argv_3492(z)   ((int) ((z)->argv_602 != 0) & (int) (z)->argv_593[0])
